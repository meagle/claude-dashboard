...
// detected by process/window presence rather than transcript events).
export const PRESENCE_SOURCES: PresenceSourceMeta[] = [
  { id: 'desktop', displayName: 'Claude Desktop', color: '#D97757', iconKey: 'claude' },
];
