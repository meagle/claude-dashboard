      ...
      {streamRow ?? (isActive && taskText
        ? (
          <div className="text-sm italic pl-[14px] mt-0.5 mb-1 text-white flex items-center gap-1.5">
            <svg className="animate-pulse shrink-0" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 509.64" width="14" height="14">
